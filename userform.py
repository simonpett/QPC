...
class UserForm(Form):
    ...
    occupation     = StringField('Occupation', [validators.Length(min=4, max=25), validators.DataRequired()], render_kw={"placeholder": "Occupation Name"})
    email        = EmailField('Email Address', [validators.Length(min=6, max=35), validators.DataRequired()], render_kw={"placeholder": "Email Name"})
    password   = PasswordField('Password', [validators.Length(min=6, max=35), validators.DataRequired()], render_kw={"placeholder": "Password Name"})
